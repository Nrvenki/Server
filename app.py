...
# Check if files exist before loading
if not os.path.exists(scaler_path) or not os.path.exists(model_path):
    logging.error("Error: 'scaler.pkl' or 'bagging.pkl' not found in the script directory")
    exit(1)
...
def predict(Glucose, BloodPressure, SkinThickness, Insulin, Bmi, Dpf, Age):
    ...
    try:
        ...
        raise ValueError("Scaling error occurred")
    ...
    try:
        ...
        raise ValueError("Prediction error occurred")
